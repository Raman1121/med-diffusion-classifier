...
def isic_plotter(output_dir: str, batches: list, samples: list, epoch: int, process_idx: int):
    """
...
def main():
    ...
    if config.flash_attention:
        ...
        dit.enable_xformers_memory_efficient_attention(attention_op=MemoryEfficientAttentionFlashAttentionOp)
