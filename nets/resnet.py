...
class ResNet2D(nn.Module):
    ...
    def __init__(
        ...
        if self.in_channels != 3:
            ...
            self.resnet.conv1.weight.data = old_conv.weight[:, 0].unsqueeze(1).data.repeat(1, in_channels, 1, 1)

        # Remove the final FC layer to get raw features by replacing it with Identity.
