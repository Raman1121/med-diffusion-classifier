...
export EXPERIMENT_DIR="/experiments/chexpert-dit"
...
export CHECKPOINT_FOLDER="$INFERENCE_CHECKPOINT_FOLDER/chexpert-256-checkpoints/chexpert-256-dit-b4-dwt"            # (str) Checkpoint folder for inference  
export FLASH_ATTENTION=true            # (bool) Whether to use the flash attention or not
