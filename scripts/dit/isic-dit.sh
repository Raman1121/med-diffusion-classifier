...
export EXPERIMENT_DIR="/experiments/isic-dit"
export DATA_PATH="$DATA_ROOT/isic_mel_balanced" # (str) Path to the isic data directory
export SEED=42
...
export PATCH_SIZE=4                     # (int) Size of the patches for the DiT
export NUM_EPOCHS=512                   # (int) Number of epochs to train for
...
export ENCODER_TYPE="DiT"               # (str) Type of encoder for the end-to-end model ('nn' or 't5')
...
export CHECKPOINT_FOLDER="$INFERENCE_CHECKPOINT_FOLDER/isic-256-checkpoints/isic-dit-b4-dwt"             # (str) Checkpoint folder for inference
export FLASH_ATTENTION=false            # (bool) Whether to use the flash attention or not (only for inference)

export CFG_W=3.5                        # (int) Classifier guidance scale
