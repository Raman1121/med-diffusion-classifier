...
export EXPERIMENT_DIR="/experiments/chexpert-unet"
...
export EMA_UPDATE_FREQ=5                # (int) Number of steps between EMA updates/evaluation
...
export CHECKPOINT_FOLDER="$INFERENCE_CHECKPOINT_FOLDER/chexpert-256-checkpoints/chexpert-unet-256-dwt-healthysick"           # (str) Checkpoint folder for inference
...
accelerate launch \
                ...
                $PROJECT_ROOT$EXPERIMENT_DIR/$FUNCTION.py  # train.py/explain.py/inference.py
